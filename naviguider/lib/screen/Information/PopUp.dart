...
class Popup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget imageCarousel = SizedBox(
      ...
      child: Carousel(
        images: [
          NetworkImage('https://www.linkingmakerandmarket.com/wp-content/uploads/2016/02/Linking-Maker-and-Market-Popup-exhibition-ecostyle-2015-1-1100x488.jpg'),
          NetworkImage('https://i.pinimg.com/originals/20/b6/d1/20b6d142e9eb4cd48fb8320384ce9f38.jpg')
        ],
        dotSize: 4.0,
        dotSpacing: 15.0,
