...
class KnowAndShare extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    Widget imageCarousel = SizedBox(
      ...
      child: Carousel(
        images: [
          ...
          Image.network('https://www.carrushome.com/media/2017/11/mini-living-shanghai-2.jpg')
        ],
        dotSize: 4.0,
        dotSpacing: 15.0,
    ...
    return MaterialApp(
      title: 'Know And Share',
      home: Scaffold(
        appBar: AppBar(
          automaticallyImplyLeading: true,
          backgroundColor: Colors.orange.shade400,
          title: Text('Know And Share'),
